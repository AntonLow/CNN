...
cl = TOBY.LINE()
cl.login(token="EnZ0V7S29xpizEDmHr28.70VK7hI7nbvbWv+8twnnca.qDpZK/Zitf4cni0ZFVuxqCft2tqBBw4GsGdDzST0Ews=")
cl.loginResult()
#MYID#
ki = TOBY.LINE()
ki.login(token="EnhGhNsrEPQCwM7zbpPb.Lr9ffojeKZaNgNi6caVAwW.YFyKYUoeQmFiFVpBxKmypsibuwJxeWqJLTwhEYQbjkY=")
ki.loginResult()
#QUEEN#
kk = TOBY.LINE()
kk.login(token="EnSMMQEYI8wQSjw81lbd.18J2HCOrkuz3oIkFAtrxNq.cGtC8OtfKsaK8tzSfL9sADs79vyd+Dq9seTpRDTmDFk=")
kk.loginResult()
#SUN#
kc = TOBY.LINE()
kc.login(token="EnvdmYHJqnQCwQTsdVA8.o++FOAgiY+AQXDKfhJsJ6a.I3/1JwEY7lwDxliLTaKtjWs0Zadno73D8v8htHc4g6k=")
kc.loginResult()
#CLOUD#
...
admin=["u813e54635fa8ca8c016090e933582652","u8d67d89eeade3917f713d3d3f22df048","uef4be4ec78bb341541c15ffc4d634d08"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : BLVCK HITTER",
    "lang":"JP",
    "comment":"Owner : CONTINENTAL",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#======[GROUP CHANGE NAME | GNC ]

            elif ("Gn " in msg.text):
				if msg.from_ in admin:
 #======[KI GROUP CHANGE NAME | GNC ]
...
#======[KI ID | MID ID "BY ADMIN" ]

            elif "Cv1 mid" == msg.text:
				if msg.from_ in admin:
					ki.sendText(msg.to,Amid)

#======[KI2 ID | MID ID "BY ADMIN" ]

            elif "Cv2 mid" == msg.text:
				if msg.from_ in admin:
					kk.sendText(msg.to,Bmid)

#======[KI3 ID | MID ID "BY ADMIN" ]
...
#======[ END OF PHARSE 0 | UNKNOW FUNGTION ]
#======[ STEALTH PICT ]
...
#======[KI KILL - KICK BAN | ADMIN ]
				...
				if msg.from_ in admin:
					if msg.toType == 2:
						...
						if matched_list == []:
							kk.sendText(msg.to,"Killed by [CONTINENTAL]™")
							kc.sendText(msg.to,"Killed by [CONTINENTAL]™")
							return
...
#-----------------------------------------------
            elif msg.text in ["Responsename","responsname"]:
				if msg.from_ in admin:
